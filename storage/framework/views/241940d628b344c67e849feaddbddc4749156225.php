...
<div id="event-create-container" class="col-md-6 offset-md-3">
    ...
    <form action="/events/update/<?php echo e($event->id); ?>" method="POST" enctype="multipart/form-data" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\thiag\Desktop\IFSP\5° Semestre\Desenvolvimento Web II\hdcevents\resources\views/events/edit.blade.php ENDPATH**/ ?>